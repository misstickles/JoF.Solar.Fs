...
{
 "use strict";
 var Global,JoF,Solar,Fs,Spa,Client,WebSharper,Operators,Obj,UI,Next,Doc,SC$1,JavaScript,Pervasives,AttrProxy,DomUtility,Seq,List,Charting,Chart,Renderers,ChartJs,Unchecked,Array,Elt,Enumerator,T,DateUtil,T$1,Arrays,Charts,LineChart,CompositeChart,ChartJsInternal,SC$2,Docs,Abbrev,Mailbox,View,DocElemNode,Attrs,Updates,Control,FSharpEvent,SC$3,ChartConfig,SeriesChartConfig,ColorConfig,SC$4,Client$1,Docs$1,RunState,NodeSet,An,Snap,Attrs$1,Dyn,SC$5,Fresh,Pervasives$1,Color,Random,PolarData,Html,attr,AttrModule,Slice,Option,BatchUpdater,IntelliFactory,Reactive,Reactive$1,Reactive$2,Util,Seq$1,Collections,HashSet,Concurrency,Anims,AppendList,Event,Event$1,List$1,AsyncBody,SC$6,CT,SC$7,HashSet$1,SC$8,Disposable,Scheduler,CancellationTokenSource,Easing,Observer,OperationCanceledException,HashSetUtil,SC$9,Lazy,DomNodes,Queue,LazyExtensionsProxy,LazyRecord,Date,Runtime,Chart$1,Math,console;
 Global=window;
 ...
 SC$1=Global.StartupCode$JoF_Solar_Fs_Spa$Client=Global.StartupCode$JoF_Solar_Fs_Spa$Client||{};
 ...
 SC$4=Global.StartupCode$WebSharper_Charting$Renderers=Global.StartupCode$WebSharper_Charting$Renderers||{};
 ...
 SC$8=Global.StartupCode$WebSharper_UI_Next$Abbrev=Global.StartupCode$WebSharper_UI_Next$Abbrev||{};
 ...
 SC$9=Global.StartupCode$WebSharper_UI_Next$AppendList=Global.StartupCode$WebSharper_UI_Next$AppendList||{};
 ...
 {
  Doc.RunById("main",Doc.Element("div",[],[Client.chart()]));
 };
 Client.chart=function()
 {
  SC$1.$cctor();
  return SC$1.chart;
 };
 Client.dateRange=function(days)
 {
  var startDate,endDate,c;
  startDate=Date.now();
  endDate=(c=Date.now(),c+days*86400000);
  return Seq.unfold(function(d)
  {
   return d<endDate?{
    $:1,
    $0:[d,d+1*86400000]
 ...
 Client.rises=function()
 {
  SC$1.$cctor();
  return SC$1.rises;
 };
 Client.sets=function()
 {
  SC$1.$cctor();
  return SC$1.sets;
 };
 ...
 SC$1.$cctor=function()
 {
  ...
  SC$1.rises=List.ofSeq(Seq.delay(function()
  {
   return Seq.map(function(d)
   {
    var c;
    return[(new Date(d)).toLocaleString(),(c=DateUtil.DatePortion(d),(new Date(c)).getDate())];
   },Client.dateRange(365));
  }));
  SC$1.sets=List.ofSeq(Seq.delay(function()
  {
   return Seq.map(function(d)
   {
    return[(new Date(d)).toLocaleString(),(new Date(d)).getMonth()+1];
   },Client.dateRange(365));
  }));
  SC$1.chart=ChartJs.Render$2(Chart.Combine(List.ofArray([Chart.Line$1(Client.rises()),Chart.Line$1(Client.sets())])),{
   $:1,
   $0:{
    $:0,
    $0:500,
 ...
 Color=Pervasives$1.Color=Runtime.Class({
  toString:function()
  {
